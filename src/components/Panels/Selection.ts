      ...
      <bim-panel>
        <bim-panel-section name="selection" label="Selection Information" icon="solar:document-bold" fixed>
          <div style="display: flex; gap: 0.375rem;">
            ...
            <bim-button style="flex: 0;" @click=${() => propsTable.downloadData("ElementData", "csv")} icon="ph:export-fill" tooltip-title="Export Data" tooltip-text="Export the shown properties to CSV."></bim-button>
          </div>
          ${propsTable}
        </bim-panel-section>
      </bim-panel> 
